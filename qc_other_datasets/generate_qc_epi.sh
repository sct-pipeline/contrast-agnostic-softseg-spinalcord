...
copy_gt_seg(){
  ...
  # FILESEG="${PATH_DATA}/derivatives/label/${SUBJECT}/func/${file/-mocomean_bold/}_${label_suffix}.nii.gz"
  FILESEG="${PATH_DATA/moco/label}/${SUBJECT}/func/${file/-mocomean_bold/}-${label_suffix}.nii.gz"
  echo ""
...
# TODO: move from derivatives to the root directory because run_batch don't search in derivatives
rsync -Ravzh ${PATH_DATA}/./${SUBJECT}/func/${SUBJECT//[\/]/_}*${contrast}.* .
